...
import com.example.vikraya.VikrayaApplication
...
private val firestore: FirebaseFirestore,
    ...
    private val _user = MutableStateFlow<Resource<User>>(com.example.vikraya.utils.Resource.Unspecified())
    val user=_user.asStateFlow()
    private val _updateInfo = MutableStateFlow<Resource<User>>(com.example.vikraya.utils.Resource.Unspecified())
    ...
    private fun saveUserInformationWithNewImage(user: User, imageUri: Uri) {
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(getApplication<VikrayaApplication>().contentResolver, imageUri)
